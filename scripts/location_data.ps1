...
$locations = @{
    "melbourne"           = @{
        ...
        intro         = "From the CBD to the Yarra Valley, Melbourne demands sophistication. Auzzie Chauffeur provides seamless transport for business, leisure, and special events. Experience Melbourne with a professional chauffeur who knows every laneway and shortcut."
