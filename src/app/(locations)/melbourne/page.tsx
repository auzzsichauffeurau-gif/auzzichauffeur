    ...
    return (
        <main className={styles.pageWrapper}>
            ...
            <section className={styles.contentSection} style={{ textAlign: 'center', maxWidth: '1200px', margin: '0 auto', padding: '0 1rem' }}>
                <h2 className={styles.sectionTitle}>The Cultural Capital</h2>

                <CityIntro city="Melbourne" />

                <p className={styles.textBlock} style={{ maxWidth: '800px', margin: '0 auto 3rem' }}>
                    From the CBD to the Yarra Valley, Melbourne demands sophistication.
                    Auzzsi Chauffeur provides seamless transport for business, leisure, and special events.
                    Experience Melbourne with a professional chauffeur who knows every laneway and shortcut.
                </p>
