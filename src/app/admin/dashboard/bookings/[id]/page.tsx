...
export default function BookingDetailsPage() {
    ...
    const handleStatusUpdate = async (newStatus: string) => {
        ...
        try {
            ...
            // Send email notification to customer on meaningful status changes
            if (['Confirmed', 'Completed', 'Cancelled'].includes(newStatus)) {
                const statusMessages: Record<string, { subject: string; heading: string; body: string }> = {
                    Confirmed: {
                        subject: `Booking Confirmed - ${booking.customer_name}`,
                        heading: 'Your Booking is Confirmed',
                        body: 'Your booking has been confirmed. We look forward to serving you.'
                    },
                    Completed: {
                        subject: `Thank You for Choosing Auzzie Chauffeur`,
                        heading: 'Trip Completed - Thank You!',
                        body: 'Your trip has been completed. We hope you had a great experience. We would love to hear your feedback!'
                    },
                    Cancelled: {
                        subject: `Booking Cancelled - ${booking.customer_name}`,
                        heading: 'Your Booking Has Been Cancelled',
                        body: 'Your booking has been cancelled. Please contact us if you have any questions or would like to rebook.'
                    }
                };
                        ...
                        body: JSON.stringify({
                            ...
                            html: `
                                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
                                    <h2 style="color: #1e3a8a;">${msg.heading}</h2>
